...
func (l *SettingLogic) UpdateSettings(ctx context.Context, updateReq *req.SettingReq) error {
	...
	if updateReq.SubtitleConcurrency <= 0 || updateReq.RepairConcurrency <= 0 {
...
func (l *SettingLogic) defaultSubtitleConcurrency() int {
	if bootstrap.Config != nil && bootstrap.Config.Concurrency.Subtitle > 0 {
		return bootstrap.Config.Concurrency.Subtitle
	}
...
func (l *SettingLogic) defaultRepairConcurrency() int {
	if bootstrap.Config != nil && bootstrap.Config.Concurrency.Repair > 0 {
		return bootstrap.Config.Concurrency.Repair
	}
